...
import { synchonizeCompletedTasks, synchonizeNotes, synchonizeTasks, synchronizeLists } from '../../utils/task.utils';
...
const ProductivityApp = () => {
  ...
  useEffect(() => {
    if(user && isLoggedFirstTime){
      ...
      console.log('Failed to synchronize data from server');
    }
  ...
  return (
    ...
    
    {
      !isMobile
      ?
      <SidebarArrow isSideBarActive={isSideBarActive} setIsSideBarActive={setIsSideBarActive} />
      :
      null
    }
