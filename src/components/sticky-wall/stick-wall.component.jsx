    ...
    <div className="m-5">
      <ComputerTitleCard
        ...
        numberOfNotifictaions={
          state.StickyNote.length > 0 ? state.StickyNote.length : "-"
        }
      />
      <div
        className={`absolute right-0 z-20 w-full shadow-2xl transition-all ${
      ...
      <div
        className={`${
          state.activeStickNoteToEdit !== null ? "blur-[4px]" : ""
        }`}
      >
