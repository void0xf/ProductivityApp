...
const TaskElement = ({ id, taskName }) => {
  ...
  return (
    <animated.div
      {...swipeHandlers}
      className={`relative flex justify-between border-b-2 border-bordercolor py-2 rounded-md transition-opacity duration-${ANIMATION_DURATION} 
